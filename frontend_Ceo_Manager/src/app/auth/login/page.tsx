...
export default function LoginPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    // --- ĐOẠN CODE TẠO TÀI KHOẢN MOCK ĐỂ TEST HỆ THỐNG ---
    if (email === 'ceo@gmail.com' && password === 'Thuthu123456@') {
      setNotice('Đăng nhập thành công với vai trò CEO (Mock Data).');
      if (authStore && typeof (authStore as any).setState === 'function') {
        (authStore as any).setState({ 
          me: { email: 'ceo@gmail.com', role: 'ceo' }, 
          user: { email: 'ceo@gmail.com', role: 'ceo' }, 
          role: 'ceo' 
        });
      }
    ...
    else if (email === 'manager@gmail.com' && password === 'Thuthu123456@') {
      setNotice('Đăng nhập thành công với vai trò MANAGER (Mock Data).');
      if (authStore && typeof (authStore as any).setState === 'function') {
        (authStore as any).setState({ 
          me: { email: 'manager@gmail.com', role: 'manager' }, 
