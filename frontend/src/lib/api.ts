...
// ==========================================
// 🆕 HÀM ĐƯỢC GỘP BỔ SUNG CHO PHÂN HỆ DASHBOARD CEO/MANAGER
// ==========================================
export async function apiRequest(method: string, url: string, data?: any): Promise<any> {
  const cleanUrl = url.startsWith('/') ? url : `/${url}`
  
  // Đồng bộ hoàn toàn việc gọi API thông qua instance 'http' Axios của hệ thống cũ
...
// Export default phòng hờ các file import theo dạng không ngoặc nhọn
export default apiRequest

// ==========================================
// CÁC HÀM API GỐC CỦA DỰ ÁN (GIỮ NGUYÊN 100%)
// ==========================================
